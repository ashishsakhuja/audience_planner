...
def run():
    ...
    """
    inputs = {
        'query': 'Find audience segments for males aged 35–44 with a high income level, living in suburban areas, who were active in the last 90 days, and with CPM below 30.'
    }
